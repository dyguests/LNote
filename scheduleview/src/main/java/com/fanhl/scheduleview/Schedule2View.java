...
public class Schedule2View extends ViewGroup {
    ...
    public Schedule2View(Context context) {
        super(context);
    }

    public Schedule2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Schedule2View(Context context, AttributeSet attrs, int defStyleAttr) {
